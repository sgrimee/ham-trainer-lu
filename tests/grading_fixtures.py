...
CASES = [
 ("452-ok","fr","Quel est le signal international de détresse en radiotéléphonie ?","MAYDAY",
  "MAYDAY","correct",None,"exact match"),
 ("452-wrong","fr","Quel est le signal international de détresse en radiotéléphonie ?","MAYDAY",
  "SOS","incorrect",None,"SOS is telegraphy, not radiotelephony"),

 ("495-ok","fr","Quels sont les types de certificats d'opérateur établis par l'Institut ?",
  "Les certificats sont : Le certificat de BASE, le certificat NOVICE et le certificat HAREC.",
  "BASE, NOVICE et HAREC","correct",None,"all three, phrased tersely"),
 ("495-partial","fr","Quels sont les types de certificats d'opérateur établis par l'Institut ?",
  "Les certificats sont : Le certificat de BASE, le certificat NOVICE et le certificat HAREC.",
  "Le certificat de BASE et le certificat HAREC.","partial",None,"NOVICE missing"),
 ("495-TRAP","fr","Quels sont les types de certificats d'opérateur établis par l'Institut ?",
  "Les certificats sont : Le certificat de BASE, le certificat NOVICE et le certificat HAREC.",
  "Le certificat de BASE, le certificat NOVICE, le certificat HAREC et le certificat CEPT Classe 1.",
  "partial","CEPT","LENIENCY TRAP: all 3 present plus an invented fourth certificate"),

 ("495-de","de","Welche Arten von Funkerzertifikate werden vom Institut ausgestellt?",
 ...
 ("445-ok","fr",'Comment épelle-t-on l\'indicatif d\'appel "LX6JO/MM"?',
  "LIMA X-RAY SIX JULIETT OSCAR SLASH MARITIME MOBILE",
  "LIMA X-RAY SIX JULIETT OSCAR SLASH MARITIME MOBILE","correct",None,"exact"),
 ("445-partial","fr",'Comment épelle-t-on l\'indicatif d\'appel "LX6JO/MM"?',
  "LIMA X-RAY SIX JULIETT OSCAR SLASH MARITIME MOBILE",
  "LIMA X-RAY SIX JULIETT OSCAR","partial",None,"suffix /MM not spelled out"),
